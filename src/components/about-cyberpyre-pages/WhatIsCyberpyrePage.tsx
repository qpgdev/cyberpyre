      ...
      <div style={{ display: "flex" }}>
        ...
        >
          ...
          <p className="game-mechanics-text">
            ...
            controls the megacorps, the Anarchs run the streets, and mortals try
            the best they can to scrape by in a world where working 80 hours a
            week still doesn’t bring in enough credits to afford a studio
            apartment. So what now?
          </p>
          <p className="game-mechanics-text">
            ...
            bones, SynthInsight optics, retractable fangs that siphon blood into
            a second stomach to reduce your hunger... with the parallel
            advancements in cybernetics in Blood Sorcery, the possibilities for
            augmentations are endless. That being said, mortals have gotten
            pretty creative with cyberware on their own. It's harder to puncture
