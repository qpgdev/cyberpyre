    ...
    <div className="scrollable-div" style={{ maxHeight: "95vh" }}>
      ...
      >
        ...
        <p className="game-mechanics-text">
          ...
          normal dice). Attribute rolls, Discipline power rolls, Operating
          System power rolls, and any other roll which utilize a character’s
        ...
        <p className="game-mechanics-text">
          ...
          obvious way. Terminal Failures often have lasting consequences, and
          can result in a cyberpsychotic episode or in a{" "}
          <strong>Cybernetic Compulsion</strong> as the character becomes
